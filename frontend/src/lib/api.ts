...
export function toggleExecution(data: { copy_trading_enabled?: boolean; grid_enabled?: boolean; grid_volatility_adjust?: boolean; mean_reversion_enabled?: boolean; contract_enabled?: boolean; dry_run?: boolean }): Promise<{ ok: boolean; updated: string[] }> {
